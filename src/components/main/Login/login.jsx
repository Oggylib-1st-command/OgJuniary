    ...
    <div className="form__inner">
      <form className="form__signin" action="">
        ...
        <label className="form__label">
          ...
          <input className="form__input" type="text" onChange={(e)=>setForm((prevState=>({...form,email:e.target.value})))} placeholder="Введите email"/>
        </label>
        <label className="form__label">
          <img className="form__icon" src={passwordIcon} alt=""/>
          <input className="form__input" type="password" onChange={(e)=>setForm((prevState=>({...form,password:e.target.value})))} placeholder="Введите пароль"/>
        </label>
